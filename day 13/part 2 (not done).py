...
for i in range(0, len(input), 4):
    ax = int(input[i][12:input[i].find(",")]) + 10000000000000
    ay = int(input[i][input[i].find("Y+")+2:]) + 10000000000000
    i += 1
    bx = int(input[i][12:input[i].find(",")]) + 10000000000000
    by = int(input[i][input[i].find("Y+")+2:]) + 10000000000000
    i += 1
    prize_x = int(input[i][9:input[i].find(",")]) + 10000000000000
    prize_y = int(input[i][input[i].find("Y=")+2:]) + 10000000000000
